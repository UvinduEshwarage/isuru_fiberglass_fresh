    ...
    <div className="space-y-6">
      <div className="rounded-3xl bg-white p-6 shadow-sm border border-slate-200">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-sm text-slate-500 uppercase tracking-[0.2em]">Inventory overview</p>
            <h1 className="text-3xl font-semibold text-slate-900">Product stock summary</h1>
          </div>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <div className="rounded-3xl bg-white p-6 shadow-sm border border-slate-200">
          ...
          <p className="mt-3 text-3xl font-semibold text-slate-900">{formatCurrency(totalStockValue)}</p>
        </div>
        <div className="rounded-3xl bg-white p-6 shadow-sm border border-slate-200">
          <p className="text-sm text-slate-500">Low stock products</p>
          <p className="mt-3 text-3xl font-semibold text-slate-900">{lowStockProducts.length}</p>
        </div>
        <div className="rounded-3xl bg-white p-6 shadow-sm border border-slate-200">
          <p className="text-sm text-slate-500">Active SKUs</p>
          <p className="mt-3 text-3xl font-semibold text-slate-900">{products.filter((product) => product.active).length}</p>
        </div>
      </div>

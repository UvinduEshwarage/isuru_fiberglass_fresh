      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-slate-500">Revenue & Sales Overview</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-4 text-slate-800 gap-5 mb-8">
          ...
          <div className="bg-white rounded-xl shadow p-5">
            <p className="text-slate-500 text-sm">Total Quantity</p>
          ...
          <div className="bg-white rounded-xl shadow p-5">
            ...
            <h2 className="text-3xl font-bold mt-2">
              {formatCurrency(dashboard.averageRevenue)}
            </h2>
          </div>
        </div>
        ...
        <section
          id="revenue-summary"
          className="bg-white rounded-xl text-slate-800 shadow p-5 mb-8"
        >
          <h2 className="font-semibold text-lg mb-2">Revenue Summary</h2>
          <p className="text-sm text-slate-500 mb-4">
            Monthly revenue trend for the business, plus top performance
            indicators.
          </p>
        ...
        <section
          id="sales-trends"
          className="bg-white text-slate-800 rounded-xl shadow p-5 mb-8"
        >
          <div className="flex flex-col gap-6">
            <div>
              <h2 className="font-semibold text-lg mb-2">Sales Trends</h2>
              <p className="text-sm text-slate-500">
                Explore category performance, quantity trends, and quarterly
                revenue insight.
              </p>
            </div>

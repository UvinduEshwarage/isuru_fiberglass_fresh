      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div>
          ...
          <p className="mt-2 text-slate-500 max-w-2xl">
            Review revenue forecasts you generated previously using the existing
        ...
        {history.length === 0 ? (
          <div className="rounded-3xl bg-white p-6 shadow-sm">
            ...
            <p className="mt-3 text-slate-500">
              The history view will list prior predictions and the input values
              used for each forecast.
            </p>
